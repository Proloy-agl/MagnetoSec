...
<body>
    ...
    <div class="container-wrapper">
        ...
        <div class="top-part">
            ...
            <asp:Image ID="Image2" runat="server" ImageUrl="~/Photos and Logos/m-big-logo.png"  class="logo1-secured" />
    ...
    <a class="right carousel-control" href="#myCarousel" data-slide="next">
      ...
      <span class="sr-only">Next</span>
        ...
        <div class="main-containt">
            ...
            <ul>
                <li><asp:Image ID="Image6" runat="server" ImageUrl="~/Photos and Logos/sm-im.jpg"    />
                    <button class="button2" data-toggle="modal" data-target="#myModal7" data-dismiss="modal">Onboard Infrastructure</button>
                </li>
                <li><asp:Image ID="Image7" runat="server" ImageUrl="~/Photos and Logos/sm-im.jpg"    />
                    <button class="button2">CI Administration</button>
                </li>
                <li><asp:Image ID="Image8" runat="server" ImageUrl="~/Photos and Logos/sm-im.jpg"    />
                    <button class="button2">CI Completeness Report</button>
                </li>
                <li><asp:Image ID="Image9" runat="server" ImageUrl="~/Photos and Logos/sm-im.jpg"    />
                    <button class="button2">Other CMDB Reports</button>
                </li>
                <li><asp:Image ID="Image10" runat="server" ImageUrl="~/Photos and Logos/sm-im.jpg"    />
