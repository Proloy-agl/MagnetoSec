...
DeleteCommand="DELETE FROM [Audit_Infrastructure_CI] where [Transaction_ID]=@Transaction_ID">
            ...
            <legend class="heading1">Grid display for attributes and relationship based on App Name</legend>
                  <div class="table-wrapper">
                      <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False" DataKeyNames="Transaction_ID" DataSourceID="SqlDataSource6">
                          <Columns>
                              <asp:BoundField DataField="CR_NUMBER" HeaderText="CR_NUMBER" SortExpression="CR_NUMBER" />
                              <asp:BoundField DataField="App_ID" HeaderText="App_ID" SortExpression="App_ID" />
                              <asp:BoundField DataField="Application_Name" HeaderText="Application_Name" SortExpression="Application_Name" />
                  ...
                  <div class="table-wrapper">
                      <asp:GridView ID="GridView7" runat="server" AutoGenerateColumns="False" DataKeyNames="Transaction_ID" DataSourceID="SqlDataSource7">
                          <Columns>
                              <asp:BoundField DataField="CR_Number" HeaderText="CR_Number" SortExpression="CR_Number" />
                              <asp:BoundField DataField="App_CI_Name" HeaderText="App_CI_Name" SortExpression="App_CI_Name" />
                              <asp:BoundField DataField="Infra_CI_Name" HeaderText="Infra_CI_Name" SortExpression="Infra_CI_Name" />
                  ...
                  <div class="table-wrapper">
                      ...
                      <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<%$ ConnectionStrings:CMDB_DB_DEVConnectionString %>" SelectCommand="SELECT * FROM [Audit_Relationship_App_to_Infra] WHERE ([App_CI_Name] = @App_CI_Name)">
                          <SelectParameters>
