      ...
      <asp:TextBox ID="TextBox2" runat="server" visible="false"></asp:TextBox>
       ...
       <br />
                     ...
                     <asp:Panel ID="Panel4" runat="server" Visible="false">
                             <fieldset class="form-content">
       <asp:Label ID="Label2" runat="server" ><h4>Applicatio Name :</h4></asp:Label>
       ...
       <br />
            ...
            <legend class="heading1">Grid display for attributes and relationship based on CR</legend>
               ...
               <div class="table-wrapper">
                   <h4>Application Attributes(Magneto)</h4>
                       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Transaction_ID" DataSourceID="SqlDataSource1" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true">
                           <Columns>
                       ...
                       <div class="table-wrapper">
                       <h4>Infra Attributes(Magneto)</h4>
                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="CR_Number" DataSourceID="SqlDataSource2" AutoGenerateEditButton="true" AutoGenerateDeleteButton="true">
                           <Columns>
...
DeleteCommand="DELETE FROM [Audit_Infrastructure_CI] where [Transaction_ID]=@Transaction_ID">
            ...
            <legend class="heading1">Grid display for attributes and relationship based on App Name</legend>
                  <div class="table-wrapper">
                      ...
                      <asp:GridView ID="GridView6" visible="false" runat="server" AutoGenerateColumns="False" DataKeyNames="Transaction_ID" DataSourceID="SqlDataSource6">
                          <Columns>
                              <asp:BoundField DataField="CR_NUMBER" HeaderText="CR_NUMBER" SortExpression="CR_NUMBER" />
                              <asp:BoundField DataField="App_ID" HeaderText="App_ID" SortExpression="App_ID" />
                              <asp:BoundField DataField="Application_Name" HeaderText="Application_Name" SortExpression="Application_Name" />
                  ...
                  <div class="table-wrapper">
                      ...
                      <asp:GridView ID="GridView8" Visible="false" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource8">
                          <Columns>
                              <asp:BoundField DataField="App_Id" HeaderText="App_Id" SortExpression="App_Id" />
                              ...
                              <asp:BoundField DataField="Remedy_Status" HeaderText="Remedy_Status" SortExpression="Remedy_Status" />
                              <asp:BoundField DataField="App_Name_Id" HeaderText="App_Name_Id" SortExpression="App_Name_Id" />
                          </Columns>
                      </asp:GridView>
                      <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:CMDB_DB_DEVConnectionString %>" SelectCommand="SELECT * FROM [CI_APP_OUT] WHERE ([Application_Name] = @Application_Name)">
                          <SelectParameters>
                              <asp:ControlParameter ControlID="TextBox3" Name="Application_Name" PropertyName="Text" Type="String" />
                          </SelectParameters>
                      </asp:SqlDataSource>
                      ...
                      <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:CMDB_DB_DEVConnectionString %>" SelectCommand="SELECT * FROM [Audit_Application_CI] WHERE ([Application_Name] = @Application_Name)">
                          <SelectParameters>
                              <asp:ControlParameter ControlID="TextBox3" Name="Application_Name" PropertyName="Text" Type="String" />
                          </SelectParameters>
                      </asp:SqlDataSource>
                  ...
                  <div class="table-wrapper">
                      ...
                      <Columns>
                         ...
                         <%-- <asp:BoundField DataField="Transaction_ID" HeaderText="Transaction_ID" InsertVisible="False" ReadOnly="True" SortExpression="Transaction_ID" />
                          <asp:BoundField DataField="Transaction_Timestamp" HeaderText="Transaction_Timestamp" SortExpression="Transaction_Timestamp" />
                          <asp:BoundField DataField="Transaction_Status" HeaderText="Transaction_Status" SortExpression="Transaction_Status" />--%>
                          <asp:BoundField DataField="App_Id1" HeaderText="App_Id_Readinow" ReadOnly="True" SortExpression="App_Id1" />
                          <asp:BoundField DataField="Data_Id" HeaderText="Data_Id" ReadOnly="True" SortExpression="Data_Id" />
                          <asp:BoundField DataField="Application_Name1" HeaderText="Application_Name_Readinow" ReadOnly="True" SortExpression="Application_Name1" />
                          ...
                          <asp:BoundField DataField="Business_Unit" HeaderText="Business_Unit" ReadOnly="True" SortExpression="Business_Unit" />
                          <asp:BoundField DataField="Description" HeaderText="Description" ReadOnly="True" SortExpression="Description" />
                          <asp:BoundField DataField="Business_Owner" HeaderText="Business_Owner" ReadOnly="True" SortExpression="Business_Owner" />
                          <asp:BoundField DataField="Technical_Owner" HeaderText="Technical_Owner" ReadOnly="True" SortExpression="Technical_Owner" />
                          <asp:BoundField DataField="Service_Delivery_Manager" HeaderText="Service_Delivery_Manager" ReadOnly="True" SortExpression="Service_Delivery_Manager" />
                          <asp:BoundField DataField="Hosting_Location" HeaderText="Hosting_Location" ReadOnly="True" SortExpression="Hosting_Location" />
                          <asp:BoundField DataField="Support_Vendor" HeaderText="Support_Vendor" ReadOnly="True" SortExpression="Support_Vendor" />
                          <asp:BoundField DataField="Manufacturer" HeaderText="Manufacturer" ReadOnly="True" SortExpression="Manufacturer" />
                          <asp:BoundField DataField="Live_Date" HeaderText="Live_Date" ReadOnly="True" SortExpression="Live_Date" />
                          <asp:BoundField DataField="Exit_Date" HeaderText="Exit_Date" ReadOnly="True" SortExpression="Exit_Date" />
                          <asp:BoundField DataField="DR_Tiering" HeaderText="DR_Tiering" ReadOnly="True" SortExpression="DR_Tiering" />
                          <asp:BoundField DataField="Architectural_Recommendation" HeaderText="Architectural_Recommendation" ReadOnly="True" SortExpression="Architectural_Recommendation" />
                          <asp:BoundField DataField="Created_Date" HeaderText="Created_Date" ReadOnly="True" SortExpression="Created_Date" />
                          <asp:BoundField DataField="Modified_Date" HeaderText="Modified_Date" ReadOnly="True" SortExpression="Modified_Date" />
                          <asp:BoundField DataField="Archived_Date" HeaderText="Archived_Date" ReadOnly="True" SortExpression="Archived_Date" />
                         <%-- <asp:BoundField DataField="Transaction_Id1" HeaderText="Transaction_Id1" ReadOnly="True" SortExpression="Transaction_Id1" />
                          ...
                          <asp:BoundField DataField="Remedy_Status" HeaderText="Remedy_Status" ReadOnly="True" SortExpression="Remedy_Status" />
                          <asp:BoundField DataField="App_Name_Id" HeaderText="App_Name_Id" ReadOnly="True"  SortExpression="App_Name_Id" />
            ...
            <legend class="heading1">Grid display for attributes and relationship based on Infra Name</legend>
                  ...
                  <div class="table-wrapper">
                      ...
                      <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:CMDB_DB_DEVConnectionString %>" SelectCommand="SELECT * FROM [Audit_Relationship_App_to_Infra] WHERE ([Infra_CI_Name] = @Infra_CI_Name)">
                          <SelectParameters>
                  ...
                  <div class="table-wrapper">
                      ...
                      <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:CMDB_DB_DEVConnectionString %>" SelectCommand="SELECT * FROM [Audit_Relationship_Infra_to_Infra] WHERE (([Child_Infra_CI_Name] = @Child_Infra_CI_Name) OR ([Parent_Infra_CI_Name] = @Parent_Infra_CI_Name))">
                          <SelectParameters>
            ...
            <legend class="heading1">Grid display for Joined Value</legend>
                  ...
                  <asp:SqlDataSource ID="SqlDataSource13" runat="server" ConnectionString="<%$ ConnectionStrings:CMDB_DB_DEVConnectionString %>" SelectCommand="select * from [dbo].[Audit_Application_CI] INNER JOIN [dbo].[CI_APP_OUT] ON [dbo].[Audit_Application_CI].Application_Name = [dbo].[CI_APP_OUT].Application_Name AND [dbo].[Audit_Application_CI].Application_Environment=[dbo].[CI_APP_OUT].Environment " UpdateCommand="UPDATE [Audit_Application_CI] SET [App_ID]=@App_ID,[Application_Name]=@Application_Name,[Application_Category]=@Application_Category,[Application_Complexity]=@Application_Complexity,[Remedy_Group]=@Remedy_Group,[Application_Environment]=@Application_Environment where [Transaction_ID]=@Transaction_ID  " DeleteCommand="DELETE FROM [Audit_Application_CI] where [Transaction_ID]=@Transaction_ID"></asp:SqlDataSource>
                  </fieldset>
                       </asp:Panel>

                  <asp:Button ID="Button2" runat="server" CssClass="button1" Text="Back to Homepage" OnClick="Button2_Click"  />
