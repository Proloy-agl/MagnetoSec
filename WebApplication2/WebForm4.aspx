                  ...
                  <div class="table-wrapper">
                      ...
                      <Columns>
                         ...
                         <%-- <asp:BoundField DataField="CI_Name1" HeaderText="CI_Name1" SortExpression="CI_Name1" />--%>
                          <asp:BoundField DataField="IP_Address" HeaderText="IP_Address" ReadOnly="True" SortExpression="IP_Address" />
                          <asp:BoundField DataField="Operating_System" HeaderText="Operating_System" ReadOnly="True" SortExpression="Operating_System" />
                          <asp:BoundField DataField="Serial_No" HeaderText="Serial_No" ReadOnly="True" SortExpression="Serial_No" />
                          <asp:BoundField DataField="In_Service" HeaderText="In_Service" ReadOnly="True" SortExpression="In_Service" />
                          <asp:BoundField DataField="Type" HeaderText="Type" ReadOnly="True" SortExpression="Type" />
                          <asp:BoundField DataField="Last_Edited_Date" HeaderText="Last_Edited_Date" ReadOnly="True" SortExpression="Last_Edited_Date" />
